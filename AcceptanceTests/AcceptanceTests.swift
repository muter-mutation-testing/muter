                    ...
                    they("have the description displayed to them") {
                        expect(self.muterRunHelpOutput).to(
                            equalWithDiff(
                                ...
                                USAGE: muter run [--files-to-mutate <files-to-mutate> ...] [--report <report>] [--skip-coverage] [--output <output>]

                                OPTIONS:
                                  --files-to-mutate <files-to-mutate>
                                                          Only mutate a given list of source code files
                                  -r, --report <report>   The report type for muter: plain, json, html, xcode
                                                          (default: plain)
