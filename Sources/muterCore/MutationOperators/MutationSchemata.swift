...
typealias SchemataMutation = (id: String, syntaxMutation: CodeBlockItemListSyntax)
...
func transform(
    ...
    guard let mutationParsed = try? SyntaxParser.parse(source: codeBlockWithMutation, parseTransition: parseTransition) else {
        return codeBlockItemListSyntax
    }
