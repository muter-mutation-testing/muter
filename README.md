...
You can check out an example of the test report that Muter generates [here](https://github.com/SeanROlszewski/muter/blob/master/Docs/test_report_example.md).
