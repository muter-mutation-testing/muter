...
You can check out an example of the test report that Muter generates [here](https://github.com/seanrolszewski/muter/Docs/test_report_example.md).

If you're curious about how a mutation score is different than test code coverage, then check out [this document](https://github.com/seanrolszewski/muter/Docs/mutation_score_vs_test_code_coverage.md).
